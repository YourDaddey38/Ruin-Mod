    ...
    internal class GlobalRecipe : ModSystem
    {
        ...
        public override void PostAddRecipes()
        {
            for (int i = 0; i < Recipe.numRecipes; i++)
            {
                ...
                {
                    recipe.AddIngredient(ModContent.ItemType<Content.Items.SoulOfBlight.SoulOfBlight>());
                }
                ...
                {
                    recipe.AddIngredient(ModContent.ItemType<Content.Items.SoulOfBlight.SoulOfBlight>(), 20);
                }

                if (recipe.TryGetResult(ItemID.AvengerEmblem, out Item AvengerEmblem))
                {
                    recipe.AddIngredient(ModContent.ItemType<Content.Items.SoulOfBlight.SoulOfBlight>(), 5);
                }
            }
        }
    }
