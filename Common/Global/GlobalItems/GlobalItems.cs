    ...
    internal class GlobalItems :GlobalItem
    {
        ...
        public override void ModifyItemLoot(Item item, ItemLoot itemLoot)
        {
            if (item.type == ItemID.TwinsBossBag)
            {
                ...
                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.SpectralArmor.SpectralHeadgear>(), 7, 1, 1));

                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.SpectralArmor.SpectralArmor>(), 7, 1, 1));

                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.SpectralArmor.SpectralSubligar>(), 7, 1, 1));
            }
            ...
            if (item.type == ItemID.SkeletronPrimeBossBag)
            {
                ...
                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.TitanArmor.TitanHelmet>(), 7, 1, 1));

                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.TitanArmor.TitanMail>(), 7, 1, 1));

                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.TitanArmor.TitanLeggings>(), 7, 1, 1));
            }
            ...
            if (item.type == ItemID.DestroyerBossBag)
            {
                ...
                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.EdgeArmor.EdgeHelmet>(), 7, 1, 1));

                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.EdgeArmor.EdgeChestplate>(), 7, 1, 1));

                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.EdgeArmor.EdgeLeggings>(), 7, 1, 1));
            }

            if (item.type == ItemID.GolemBossBag)
            {
                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.DragonArmor.DragonHelmet>(), 7, 1, 1));
                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.DragonArmor.DragonChestplate>(), 7, 1, 1));
                itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Content.Armor.Hardmode.DragonArmor.DragonLeggings>(), 7, 1, 1));
            }
